...
"""
Modern Django Configuration for CA Firm Platform
Follows security best practices and production standards
"""
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/hour',
        'user': '1000/hour',
        'auth': '5/hour',  # For login/register
    },
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CA Firm API',
    'DESCRIPTION': 'Backend API for CA firm management'}